...
try {
    ...
    if ($idPrato <= 0 || $userId <= 0 || $restauranteId <= 0 || $nome === '') {
        respond(['ok' => false, 'error' => 'Dados insuficientes para atualizar prato'], 422);
    }
    ...
    $sql = "UPDATE dbo.Prato SET NomePrato = :nome, Descricao = :descricao, Categoria = :categoria, Preco = :preco, ImagemUrl = :imagemUrl WHERE IdPrato = :idPrato AND RestauranteId = :restauranteId";
    ...
    respond(['ok' => true, 'message' => 'Prato atualizado com sucesso']);
